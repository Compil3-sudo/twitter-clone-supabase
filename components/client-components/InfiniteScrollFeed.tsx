...
const InfiniteScrollFeed = ({
  ...
  const [page, setPage] = useState(firstTweetsPage.length > 0 ? 1 : 0); // get first page 0 from server or fetch in client
  ...
  if (firstTweetsPage.length > 0) {
    lastTweet = firstTweetsPage[0];
  } else {
    lastTweet = tweets[0];
  }
    ...
    <>
      ...
      <div className="flex flex-col items-center w-full">
        <div className="w-full">
          ...
          ) : tweets.length === 0 && page === 0 && hasMore === false ? (
